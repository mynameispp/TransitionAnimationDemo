...
package com.ffzxnet.transitionanimationdemo.view.loading;
...
public class LeafLoadingView extends View {
    ...
    // 进度条 橙色
    private static final int ORANGE_COLOR = 0xffff4081;
    // 中等振幅大小
...
//            mProgress = 0;
    ...
    private void initBitmap() {
        mLeafBitmap = ((BitmapDrawable) ContextCompat.getDrawable(this.getContext(), R.mipmap.leaf)).getBitmap();
        mLeafWidth = mLeafBitmap.getWidth();
        mLeafHeight = mLeafBitmap.getHeight();

        mOuterBitmap = ((BitmapDrawable) ContextCompat.getDrawable(this.getContext(), R.mipmap.leaf_kuang)).getBitmap();
